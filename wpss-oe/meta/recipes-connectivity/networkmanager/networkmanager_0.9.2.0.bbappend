...
SRC_URI += "file://enable-keyfile-plugin.patch \
...
do_install_append () {
	...
	install -m 0600 ${WORKDIR}/CERN ${D}${sysconfdir}/NetworkManager/system-connections/
	install -m 0600 ${WORKDIR}/wpssconfig ${D}${sysconfdir}/NetworkManager/system-connections/
